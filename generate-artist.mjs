...
const renderVisionCrateItem = release => `    <a class="crate-cover" href="${escapeHtml(release.link)}" target="_blank" rel="noopener" data-track-event="casa_catalogo_click" data-track-label="casa_catalogo_cover" data-track-content="${escapeHtml(release.title)}">
